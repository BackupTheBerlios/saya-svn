...
/* THIS FILE WAS ALTERED BY Rick Garcia, September 12, 2008
 *
 * This copy of tinyxml was altered for the exclusive use
 * with the Saya Video Editor. If you want to use TinyXML,
 * better get an unaltered version instead.
 *
 * Changes: Got rid of tinystr and used the STL instead.
 */
